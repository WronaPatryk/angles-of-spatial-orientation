...
#v.plot_analyse('data/testout2.csv', 0.01, [5, 6, "ACCEL_X [g]", "ACCEL_Y [g]"])
...
#v.normal_chart_2_time('data/test2.csv', 1 ,4, "PITCH", "PITCH*", [0,-90, 90, 0, "DEG", "PITCH, PITCH*"])

v.normal_chart_1_time('data/testout2.csv', 18, "E_ROLL%", [1,-1,1, 0, "BŁĄD BEWZGLĘDNY", "E_ROLL%"])
...
#v.normal_chart_XYZ('data/testout.csv', 0, 4, "ROLL","ROLL*", ["time [s]", "ROLL[s]", 0, 190, "ROLL(time)"])
